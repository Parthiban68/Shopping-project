...
const ProductDetails = () => {
  ...
  return (
    <div>
        {data.map((item) => (
<section className="py-12 sm:py-5 mb-10"> 
  <div className="container mx-auto px-4">
    <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
        ...
        <div className="lg:flex lg:items-start">
          <div className="lg:order-2 lg:ml-5">
            <div className="max-w-xl overflow-hidden rounded-lg">
              <img className="h-[500px] w-[500px] max-w-full object-cover" src={item.poster} alt="" />
            </div>
          </div>
      ...
      <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
        <h1 className="sm: text-2xl font-bold text-gray-900 sm:text-3xl">{item.shoemodel}</h1>
        ...
        <div className="mt-3 flex select-none flex-wrap items-center gap-5">
          <label>
            <input type="radio" name="subscription" value="5" className="peer sr-only" />
            <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold text-center">5</p>
            <span className="mt-1 block text-center text-xs text-green-600">Stock Available</span>
          </label>
          <label>
            <input type="radio" name="subscription" value="6" className="peer sr-only"/>
            <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold text-center">6</p>
            <span className="mt-1 block text-center text-xs text-green-600">Stock Available</span>
          </label>
          <label>
            <input type="radio" name="subscription" value="8" className="peer sr-only" disabled />
            <p className="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold text-center">7</p>
            <span className="mt-1 block text-center text-xs text-red-600">Not Available</span>
          </label>
        </div>

        <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
          <div className="flex items-end">
            <h1 className="text-3xl font-bold"><i class="fa-solid fa-indian-rupee-sign"></i> {item.mrp}</h1>
          </div>
      ...
      <div className="lg:col-span-3">
        ...
        <div className="mt-8 flow-root sm:mt-12">
          ...
          <h1 className="mt-8 text-3xl font-bold">From the Finest industry of India</h1>
