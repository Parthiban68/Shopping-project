        ...
        <div class="grid grid-cols-2">
            <div className='w-100% h-[545px] mt-[46px]'>
                <div className='mt-[150px] px-[50px]'>
                    <h1 className='text-[40px] font-bold cursor-pointer flex'>Task Management App</h1>
                    ...
                    <button className='text-white bg-orange-600 p-2 rounded-2xl mt-[7px]'>See Task</button>
                </div>
            </div>
